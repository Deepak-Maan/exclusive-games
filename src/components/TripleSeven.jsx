...
const TripleSeven = () => {
    return (
        <div className='relative overflow-x-clip'>
            <div className='w-[440px] max-lg:hidden h-[440px] rounded-full bg-blue-307 absolute top-0 left-[-10%]  blur-[180px] animate-pulse'></div>
            <div className='w-[440px] max-lg:hidden h-[440px] rounded-full bg-blue-307 absolute bottom-0 right-[-10%] blur-[180px] animate-pulse'></div>
            <div className="max-w-[1140px] mx-auto px-3 py-7 sm:py-10 md:pt-[100px] md:pb-[150px]">
                <div className="grid lg:grid-cols-2 -mx-3 justify-between">
                    <div className=" px-3 relative z-[5] max-w-[558px]">
